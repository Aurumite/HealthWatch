...
module ADC_SAR_SEQ_P4_v2_40_0 (
	...
	cy_clock_v1_0
		#(.id("fc653501-fa02-4731-a157-bb1a1a3cef5f/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
module BLE_v3_20_1 (
	...
	cy_clock_v1_0
		#(.id("16af5475-934b-47bc-8cfc-23340e191ee5/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__TAO_net;
	wire [0:0] tmpFB_0__TAO_net;
	wire [0:0] tmpIO_0__TAO_net;
	wire [0:0] tmpINTERRUPT_0__TAO_net;
	electrical [0:0] tmpSIOVREF__TAO_net;
	...
	cy_psoc3_pins_v1_10
		...
		TAO
		 (.oe(tmpOE__TAO_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TAO_net[0:0]}),
		  .analog({Net_25}),
		  .io({tmpIO_0__TAO_net[0:0]}),
		  .siovref(tmpSIOVREF__TAO_net),
		  .interrupt({tmpINTERRUPT_0__TAO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TAO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    BLE_v3_20_1 BLE_1 (
        .clk(Net_33),
        .pa_en(Net_34));

	wire [0:0] tmpOE__BLED_net;
	wire [0:0] tmpFB_0__BLED_net;
	wire [0:0] tmpIO_0__BLED_net;
	wire [0:0] tmpINTERRUPT_0__BLED_net;
	electrical [0:0] tmpSIOVREF__BLED_net;
	...
	cy_psoc3_pins_v1_10
		...
		BLED
		 (.oe(tmpOE__BLED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BLED_net[0:0]}),
		  .io({tmpIO_0__BLED_net[0:0]}),
		  .siovref(tmpSIOVREF__BLED_net),
		  .interrupt({tmpINTERRUPT_0__BLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
