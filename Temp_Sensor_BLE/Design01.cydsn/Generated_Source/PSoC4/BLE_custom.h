...
#define CYBLE_TEMPSENSOR_TEMPERATURE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
...
#define CYBLE_TEMPSENSOR_TEMPERATURE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0012u) /* Handle of Client Characteristic Configuration descriptor */
