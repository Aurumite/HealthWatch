...
#define CYBLE_TEMPSENSOR_SERVICE_INDEX   (0x00u) /* Index of TempSensor service in the cyBle_customs array */
#define CYBLE_TEMPSENSOR_TEMPERATURE_CHAR_INDEX   (0x00u) /* Index of Temperature characteristic */
#define CYBLE_TEMPSENSOR_TEMPERATURE_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_TEMPSENSOR_TEMPERATURE_TEMP1CCCD_DESC_INDEX   (0x01u) /* Index of temp1CCCD descriptor */
#define CYBLE_TEMPSENSOR_TEMPERATURE2_CHAR_INDEX   (0x01u) /* Index of Temperature2 characteristic */
#define CYBLE_TEMPSENSOR_TEMPERATURE2_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_TEMPSENSOR_TEMPERATURE2_TEMP2CCCD_DESC_INDEX   (0x01u) /* Index of temp2CCCD descriptor */


#define CYBLE_TEMPSENSOR_SERVICE_HANDLE   (0x000Eu) /* Handle of TempSensor service */
#define CYBLE_TEMPSENSOR_TEMPERATURE_DECL_HANDLE   (0x000Fu) /* Handle of Temperature characteristic declaration */
#define CYBLE_TEMPSENSOR_TEMPERATURE_CHAR_HANDLE   (0x0010u) /* Handle of Temperature characteristic */
#define CYBLE_TEMPSENSOR_TEMPERATURE_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0011u) /* Handle of Custom Descriptor descriptor */
#define CYBLE_TEMPSENSOR_TEMPERATURE_TEMP1CCCD_DESC_HANDLE   (0x0012u) /* Handle of temp1CCCD descriptor */
#define CYBLE_TEMPSENSOR_TEMPERATURE2_DECL_HANDLE   (0x0013u) /* Handle of Temperature2 characteristic declaration */
#define CYBLE_TEMPSENSOR_TEMPERATURE2_CHAR_HANDLE   (0x0014u) /* Handle of Temperature2 characteristic */
#define CYBLE_TEMPSENSOR_TEMPERATURE2_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0015u) /* Handle of Custom Descriptor descriptor */
#define CYBLE_TEMPSENSOR_TEMPERATURE2_TEMP2CCCD_DESC_HANDLE   (0x0016u) /* Handle of temp2CCCD descriptor */
